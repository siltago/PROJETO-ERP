    ...
    <form onSubmit={handleSubmit} className="card p-5 space-y-4">
      ...
      <label className="flex cursor-pointer items-start gap-3">
        <div
          ...
          className={`mt-0.5 relative h-5 w-9 rounded-full transition-colors shrink-0 ${isFaturamentoDireto ? "bg-steel" : "bg-line"}`}
        >
        ...
        <div>
          <p className="text-sm font-medium text-ink">Faturamento Direto</p>
