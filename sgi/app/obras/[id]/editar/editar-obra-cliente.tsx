...
import { editarObra } from "@/app/obras/actions";
    ...
    <form onSubmit={handleSubmit} className="card p-6">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
        <div className="sm:col-span-2">
          <label className="label">Nome da obra <span className="text-red-500">*</span></label>
        ...
        <div>
          <label className="label">Data prevista <span className="text-ink-soft font-normal">(opcional)</span></label>
          <input
            type="date"
            name="data_prevista"
      ...
      <div className="mt-6 flex gap-3">
        ...
        <a href={`/obras/${obra.id}`} className="btn-ghost">Cancelar</a>
      </div>
    </form>
  );
}
